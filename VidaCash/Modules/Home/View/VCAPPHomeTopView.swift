...
class VCAPPHomeTopView: UIImageView {
    ...
    private lazy var titleLab: UILabel = UILabel.buildNormalLabel()
    private lazy var amountLab: UILabel = UILabel.buildNormalLabel(font: UIFont.specialFont(62), labelColor: .white)
    private lazy var lineView: UIView = UIView(frame: CGRectZero)
    private lazy var timeLab: UILabel = UILabel.buildNormalLabel()
    private lazy var rateLab: UILabel = UILabel.buildNormalLabel()

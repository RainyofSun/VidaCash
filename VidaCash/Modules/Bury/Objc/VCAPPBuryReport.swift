...
class VCAPPBuryReport: NSObject {
    ...
    class func VCAPPDeviceInfoReport() {
        ...
        memoryModel.blu = "\(UIDevice.current.memoryTotal)"
        memoryModel.ray = UIDevice.getFreeMemory()
    ...
    /// 风控信息上报
    class func VCAPPRiskControlInfoReport(riskType: VCRiskControlBuryReportType, beginTime: String? = nil, endTime: String? = nil, orderNum: String? = nil) {
        var params: [String: String] = [:]

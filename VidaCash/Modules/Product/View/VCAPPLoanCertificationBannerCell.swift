...
class VCAPPLoanCertificationBannerCell: JXBannerBaseCell {
    ...
    private lazy var stateLab: UILabel = UILabel.buildNormalLabel(font: UIFont.systemFont(ofSize: 14), labelColor: .white, labelText: VCAPPLanguageTool.localAPPLanguage("certification_uncomplete"))

...
class VCAPPCertificationInfoItemView: UIImageView {
    ...
    private lazy var titleLab: UILabel = UILabel.buildNormalLabel(font: UIFont.boldSystemFont(ofSize: 15), labelColor: .white)
    private lazy var inputTextFiled: VCAPPNoActionTextFiled = {
        let view = VCAPPNoActionTextFiled.buildNormalTextFiled(placeHolder: NSAttributedString(string: VCAPPLanguageTool.localAPPLanguage("certification_card_pop_place"), attributes: [.foregroundColor: GRAY_COLOR_999999, .font: UIFont.systemFont(ofSize: 18)]))

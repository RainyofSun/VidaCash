...
class VCAPPCertificationInfoCityPopView: VCAPPBasePopView {
    ...
    private lazy var cityButton1: UIButton = UIButton.buildNormalButton(VCAPPLanguageTool.localAPPLanguage("certification_card_pop_city_btn"), titleColor: GRAY_COLOR_999999)
    private lazy var cityButton2: UIButton = UIButton.buildNormalButton(VCAPPLanguageTool.localAPPLanguage("certification_card_pop_city_btn"), titleColor: GRAY_COLOR_999999)
...
extension VCAPPCertificationInfoCityPopView: APPCertificationPopTableProtocol {
    func didSelectedCity(tableView: VCAPPCertificationPopTableView, didSelectRowAt indexPath: IndexPath) {
        if tableView == self.leftTableView {
            ...
            self.cityButton1.setTitleColor(BLUE_COLOR_2C65FE, for: UIControl.State.normal)
        ...
        if tableView == self.rightTableView {
            ...
            self.cityButton2.setTitleColor(BLUE_COLOR_2C65FE, for: UIControl.State.normal)

...
class VCAPPCertificationPopTableViewCell: UITableViewCell {
    ...
    private lazy var titleLab: UILabel = UILabel.buildNormalLabel(font: UIFont.systemFont(ofSize: 16, weight: UIFont.Weight.medium), labelColor: BLACK_COLOR_202020)
    ...
    override func setSelected(_ selected: Bool, animated: Bool) {
        ...
        self.titleLab.textColor = selected ? BLUE_COLOR_2C65FE : BLACK_COLOR_202020
    }

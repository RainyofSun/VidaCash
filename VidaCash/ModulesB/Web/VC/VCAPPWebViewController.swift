...
class VCAPPWebViewController: VCAPPBaseViewController {
    ...
    private lazy var processBarView: UIProgressView = {
        ...
        view.trackTintColor = RED_COLOR_F21915
        view.tintColor = PINK_COLOR_FE6826
        view.isHidden = true
        return view
    }()
...
extension VCAPPWebViewController: WKScriptMessageHandler {
    ...
    func userContentController(_ userContentController: WKUserContentController, didReceive message: WKScriptMessage) {
        ...
        if message.name == ConfirmApplyBury {
            ...
            // 埋点
            VCAPPBuryReport.VCClasJoskeRiskControlInfoReport(riskType: VCRiskControlBuryReportType.APP_EndLoanApply, beginTime: self.buryReportBeginTime, endTime: Date().jk.dateToTimeStamp(), orderNum: VCAPPCommonInfo.shared.productOrderNum)
        }
    }
}

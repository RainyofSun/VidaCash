...
class VCAPPCardInfoPopView: VCAPPBasePopView {
    ...
    private lazy var tipLab: UILabel = UILabel.buildVdidaCashNormalLabel(font: UIFont.systemFont(ofSize: 12), labelColor: UIColor.init(hexString: "#FF6A00")!, labelText: VCAPPLanguageTool.localAPPLanguage("certification_card_pop_tip"))
    ...
    override func buildPopViews() {
        ...
        self.idItem.inputTextFiledView.keyboardType = .default

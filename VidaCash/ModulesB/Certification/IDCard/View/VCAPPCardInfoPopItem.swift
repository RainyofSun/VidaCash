...
class VCAPPCardInfoPopItem: UIView {
    ...
    private lazy var titleLab: UILabel = UILabel.buildVdidaCashNormalLabel(font: UIFont.systemFont(ofSize: 15), labelColor: GRAY_COLOR_999999)
    private(set) lazy var inputTextFiledView: VCAPPNoActionTextFiled = VCAPPNoActionTextFiled.buildVidasdCashNormalTextFiled(placeHolder: NSAttributedString(string: VCAPPLanguageTool.localAPPLanguage("certification_card_pop_place"), attributes: [.foregroundColor: GRAY_COLOR_999999, .font: UIFont.systemFont(ofSize: 14)]))
    ...
    init(frame: CGRect, itemType type: APPCardInfoPopItemType) {
        ...
        self.inputTextFiledView.layer.borderColor = RED_COLOR_F21915.cgColor

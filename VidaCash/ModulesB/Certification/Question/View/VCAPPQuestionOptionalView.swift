...
class VCAPPQuestionOptionalView: UIControl {
    ...
    private(set) lazy var titleLab: UILabel = UILabel.buildVdidaCashNormalLabel(font: UIFont.systemFont(ofSize: 15), labelColor: BLACK_COLOR_202020)
    private lazy var completeImgView: UIImageView = UIImageView(image: UIImage(named: "certification_question_complete"))
    
    override var isSelected: Bool {
        didSet {
            self.backgroundColor = isSelected ? RED_COLOR_F21915 : PINK_COLOR_FFE9DD

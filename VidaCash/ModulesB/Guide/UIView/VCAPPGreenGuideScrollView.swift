...
class VCAPPGreenGuideScrollView: UIScrollView {
    ...
    public func reloadGuideText() {
        ...
        tempStr.append(NSAttributedString.init(string: VCAPPLanguageTool.localAPPLanguage("guide_content4"), attributes: [.foregroundColor: RED_COLOR_F21915, .font: UIFont.specialFont(26)]))

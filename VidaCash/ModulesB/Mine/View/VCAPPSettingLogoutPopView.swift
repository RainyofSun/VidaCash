...
class VCAPPSettingLogoutPopView: VCAPPBasePopView {
    ...
    private lazy var tipLab: UILabel = UILabel.buildVdidaCashNormalLabel(font: UIFont.systemFont(ofSize: 15), labelColor: BLACK_COLOR_202020, labelText: VCAPPLanguageTool.localAPPLanguage("mine_setting_logout_tip"))
    private lazy var logoutBtn: VCAPPLoadingButton = VCAPPLoadingButton.buildVidaCashGradientLoadingButton(VCAPPLanguageTool.localAPPLanguage("mine_setting_logout_title"), cornerRadius: 25)

...
class VCAPPHomeBigCardView: UIView {
    ...
    private lazy var applyBtn: VCAPPLoadingButton = VCAPPLoadingButton.buildVidaCashGradientLoadingButton("", cornerRadius: 25)
    private lazy var arrowImgView: UIImageView = UIImageView(image: UIImage(named: "home_loan_arrow_image"))
    private lazy var stepLab: UILabel = UILabel.buildVdidaCashNormalLabel(font: UIFont.specialFont(20), labelColor: UIColor.init(hexString: "#FF8000")!, labelText: VCAPPLanguageTool.localAPPLanguage("home_big_card_step"))
    private lazy var tipLab1: UILabel = UILabel.buildVdidaCashNormalLabel()
    ...
    private lazy var leftLab: UILabel = UILabel.buildVdidaCashNormalLabel()
    private lazy var rightLab: UILabel = UILabel.buildVdidaCashNormalLabel()
    
    private lazy var serviceBtn: UIButton = UIButton.buildVidaNormalImageButton(VCAPPCommonInfo.shared.countryCode == 1 ? "home_service_en" : "home_service_es")
    private lazy var aboutBtn: UIButton = UIButton.buildVidaNormalImageButton(VCAPPCommonInfo.shared.countryCode == 1 ? "home_about_us_en" : "home_about_us_es")
    private lazy var tipLab2: UILabel = UILabel.buildVdidaCashNormalLabel()
